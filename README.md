# 0x16. C - Simple Shell
-   By Julien Barbier
-   Project to be done in teams of 2 people (this team is comprised of: Thapelo Moumakoe, Tsumee Moloisi
...
-   `unsetenv`
	...
	*   Comman syntax: `unsetenv VARIABLE`
	*   Should print something on stderr on failure
...
Implement the builtin commane `cd`:
...
-   Implement the `alias` buuiltin command
